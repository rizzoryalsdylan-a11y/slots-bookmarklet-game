...
- 1500ms spinning animation for suspense
...
3. Set the URL to the full `javascript:...` code (see Option 1)
4. Name it "🎰 Slot Machine"
5. Save and enjoy!
